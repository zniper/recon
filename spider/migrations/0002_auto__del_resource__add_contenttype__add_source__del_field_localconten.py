...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Source'
        db.create_table(u'spider_source', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'spider', ['Source'])

        # Deleting field 'LocalContent.resource'
        db.delete_column(u'spider_localcontent', 'resource_id')

        # Adding field 'LocalContent.source'
        db.add_column(u'spider_localcontent', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='content', null=True, to=orm['spider.Source']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'spider_source')


        # User chose to not deal with backwards NULL issues for 'LocalContent.resource'
        raise RuntimeError("Cannot reverse this migration. 'LocalContent.resource' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'LocalContent.resource'
        db.add_column(u'spider_localcontent', 'resource',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='content', to=orm['spider.Resource']),
                      keep_default=False)

        # Deleting field 'LocalContent.source'
        db.delete_column(u'spider_localcontent', 'source_id')
